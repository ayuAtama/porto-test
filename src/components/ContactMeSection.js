            ...
            <VStack spacing={4}>
              ...
              <FormControl>
                ...
                <Select id="type" name="type">
                  <option value="hireMe" style={{ color: "black", backgroundColor: "white" }}>Freelance project proposal</option>
                  <option value="openSource" style={{ color: "black", backgroundColor: "white" }}>
